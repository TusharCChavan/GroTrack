...
public class GroIndexViewModel extends BaseViewModel {
    ...
    public GroIndexViewModel(@NonNull Application application) {
        super(application);
    }
    ...
    public String image_path(String key, ClientAnalysis clientAnalysis,boolean closeup_3xcloseup){
        String path="";
