...
public class PatientsResultFragment extends BaseFragment {
    ...
    private void initViews() {
        ...
        views.selectPatient1.setOnClickListener(this::onClickPastScane);
  ...
  private void onClickPastScane(View view) {
        Bundle bundle=new Bundle();
        bundle.putBoolean("pastscane",true);
        mainViewModel.setSelectedPatient(patient);
        Navigation.findNavController(view)
                .navigate(R.id.action_cameraFragment_to_returnToHomeScreen, bundle);
    }
}